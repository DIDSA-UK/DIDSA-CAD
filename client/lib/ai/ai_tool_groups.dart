...
const Map<String, AiToolGroup> aiToolGroups = {
  ...
  'assembly': AiToolGroup(
    label: 'Assembly editing (Add/Mate/Move/Hide/Isolate/Pattern)',
    kinds: {'add_component', 'mate', 'move_component', 'hide_component', 'isolate_component', 'pattern_component'},
    vocabularyText: assemblyVocabularyText,
    manualToolHint:
        'the Assembly lens tools (Add Component, Add Mate, the Move/Rotate gizmo, Hide/Show, Isolate, Pattern Component)',
  ),
};

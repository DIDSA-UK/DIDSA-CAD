...
- **Branch**: `claude/lod-phase2-client-jobs`. **PR open**: [PR #182](https://github.com/DIDSA-UK/DIDSA-CAD/pull/182). Based on `main` after confirming PR #179 (chunks 1+2),

...
Verified: `flutter analyze` clean; full client suite 872/873 (same pre-existing GPU-flakiness failure, unchanged); full backend suite 868/896 passing (same 28 pre-existing, unrelated failures). Not yet confirmed on a real device.

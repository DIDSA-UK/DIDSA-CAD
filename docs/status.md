...
Verified: 10/10 new backend tests pass; full client suite 288/288 (the OCCT-bound half untested by the same long-standing environment gap; the pure-math layer is fully covered). Installed on the real test device.
